...
let ScriptsController = (() => {
    ...
    var ScriptsController = _classThis = class {
        constructor(scriptsService) {
            this.scriptsService = (__runInitializers(this, _instanceExtraInitializers), scriptsService);
        }
        getSalesScripts() {
        ...
        createSalesScript(data) {
            return __awaiter(this, void 0, void 0, function* () {
                return this.scriptsService.createSalesScript(data);
            });
        }
        updateSalesScript(id, data) {
            return __awaiter(this, void 0, void 0, function* () {
                return this.scriptsService.updateSalesScript(id, data);
            });
        }
    };
    __setFunctionName(_classThis, "ScriptsController");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _getSalesScripts_decorators = [(0, common_1.Get)()];
        _createSalesScript_decorators = [(0, common_1.Post)()];
        _updateSalesScript_decorators = [(0, common_1.Put)(':id')];
        ...
        ScriptsController = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ScriptsController = _classThis;
})();
