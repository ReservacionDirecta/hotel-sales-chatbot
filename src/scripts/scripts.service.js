...
let ScriptsService = (() => {
    ...
    let _classThis;
    var ScriptsService = _classThis = class {
        constructor(prisma) {
            this.prisma = prisma;
            this.logger = new common_1.Logger(ScriptsService.name);
        }
        getSalesScripts() {
            return __awaiter(this, void 0, void 0, function* () {
                try {
                    const scripts = yield this.prisma.salesScript.findMany({
                        where: { active: true },
                        orderBy: {
                            id: 'asc'
                        }
        ...
        createSalesScript(data) {
            return __awaiter(this, void 0, void 0, function* () {
                try {
                    const script = yield this.prisma.salesScript.create({
                        data: Object.assign(Object.assign({}, data), { active: true, createdAt: new Date(), updatedAt: new Date() })
                    });
        ...
        updateSalesScript(id, data) {
            return __awaiter(this, void 0, void 0, function* () {
                try {
                    const script = yield this.prisma.salesScript.update({
                        where: { id },
    ...
    __setFunctionName(_classThis, "ScriptsService");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        ScriptsService = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ScriptsService = _classThis;
})();
