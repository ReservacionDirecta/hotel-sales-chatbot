...
let SalesScript = (() => {
    ...
    (() => {
        ...
        _createdAt_decorators = [(0, typeorm_1.Column)({ type: 'datetime', default: () => 'CURRENT_TIMESTAMP' })];
        _updatedAt_decorators = [(0, typeorm_1.Column)({ type: 'datetime', default: () => 'CURRENT_TIMESTAMP' })];
