...
let SeedService = (() => {
    ...
    let _classThis;
    var SeedService = _classThis = class {
        ...
        onApplicationBootstrap() {
            return __awaiter(this, void 0, void 0, function* () {
                yield this.seedHotelAndRooms();
            });
        }
        seedHotelAndRooms() {
            return __awaiter(this, void 0, void 0, function* () {
                const hotelCount = yield this.hotelRepository.count();
                if (hotelCount === 0) {
                    try {
                        // Create hotel first
                        const hotel = yield this.hotelRepository.save({
                            name: 'Hotel Cascade',
                        ...
                        yield this.roomRepository.save(rooms);
