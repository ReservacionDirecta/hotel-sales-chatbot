...
exports.SalesScriptController = void 0;
const common_1 = require("@nestjs/common");
let SalesScriptController = (() => {
    let _classDecorators = [(0, common_1.Controller)('hotel/sales-scripts')];
    ...
    var SalesScriptController = _classThis = class {
        constructor(salesScriptService) {
            this.salesScriptService = (__runInitializers(this, _instanceExtraInitializers), salesScriptService);
        }
        findAll() {
    ...
    __setFunctionName(_classThis, "SalesScriptController");
    (() => {
        ...
        SalesScriptController = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return SalesScriptController = _classThis;
})();
exports.SalesScriptController = SalesScriptController;
