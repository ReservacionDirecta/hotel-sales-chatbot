...
let HotelInfo = (() => {
    ...
    var HotelInfo = _classThis = class {
        constructor() {
            ...
            this.createdAt = (__runInitializers(this, _policies_extraInitializers), __runInitializers(this, _createdAt_initializers, void 0));
    ...
    (() => {
        ...
        _amenities_decorators = [(0, typeorm_1.Column)('simple-json', { nullable: true })];
        _policies_decorators = [(0, typeorm_1.Column)('simple-json', { nullable: true })];
