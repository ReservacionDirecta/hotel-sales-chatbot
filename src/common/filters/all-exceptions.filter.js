...
let AllExceptionsFilter = (() => {
    ...
    var AllExceptionsFilter = _classThis = class {
            ...
            console.error(`[Error] ${request.method} ${request.url}:`, Object.assign(Object.assign({}, errorResponse), { stack: exception instanceof Error ? exception.stack : 'No stack trace available' }));
