...
let HttpExceptionFilter = (() => {
    let _classDecorators = [(0, common_1.Catch)(common_1.HttpException)];
    ...
    var HttpExceptionFilter = _classThis = class {
            ...
            console.error(`[Error] ${request.method} ${request.url}:`, Object.assign(Object.assign({}, errorResponse), { stack: exception.stack }));
